...
public class CopyOfCopyOfsimilarityOfItme_1 {
	...
	public static void main(String[] args) throws Exception {
		...
		CopyOfCopyOfsimilarityOfItme_1 sof = new CopyOfCopyOfsimilarityOfItme_1();
		MorphoSimilarity similarity = MorphoSimilarity.getInstance();
		StringBuffer IO= new StringBuffer();
	
		try{
			File file = new File("./movie_similarity_matrix_1.txt");
//			if (file.exists()) {
//				file.delete();
//			}
			file.createNewFile();
